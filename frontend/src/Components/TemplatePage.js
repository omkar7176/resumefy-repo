...
const TemplatePage = () => {
  ...
  // Apply the selected color to the theme dynamically
  React.useEffect(() => {
  ...
  const handleChooseTemplate = () => {
    if (selectedTemplate) {
      navigate("/resume", { state: { templateId: selectedTemplate } }); // Pass templateId
    } else {
  ...
  return (
    <div className="template-page">
      <div className="filters-section">
        ...
        <button
          className="clear-filters enhanced-clear-filters"

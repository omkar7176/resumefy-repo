...
import styles from "./Template97.module.css";

const Template97 = forwardRef(({ information, sections, activeColor }, ref) => {
  const info = {
    ...
    >
      ...
      <div className={styles.leftSection}>
        ...
        <div className={`${styles.section} ${styles.contactSection}`}>
          <h2>Contact</h2>
          {info.basicInfo.phone && <p className={styles.contactInfo}>Phone: {info.basicInfo.phone}</p>}
          {info.basicInfo.email && <p className={styles.contactInfo}>Email: {info.basicInfo.email}</p>}
        </div>
      </div>

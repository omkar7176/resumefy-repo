...
const Template32 = forwardRef((props, ref) => {
  const [info] = useState({
    basicInfo: {
      name: "John Doe",
    ...
    projects: [
      ...
      },
      {
        ...
        points: [
          "Built a personal portfolio website using React.js, Next.js, and Tailwind CSS.",
          "Showcases projects, blogs, and interactive resume with optimized performance.",
          "Showcases projects, blogs, and interactive resume with optimized.",
        ],
      },
    ],
    achievements: [
    ...
    summary: [
      "Experienced Frontend Developer with expertise in React.js, Next.js, and UI/UX optimization. Experienced Frontend Developer with expertise in React.js, Next.js, and UI/UX optimization.",
    ],
    other: [

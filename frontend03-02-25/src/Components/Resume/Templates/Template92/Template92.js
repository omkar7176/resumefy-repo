...
import styles from "./Template92.module.css";

const Template92 = forwardRef(({ information, sections, activeColor }, ref) => {
  const info = {
      ...
      <div className={styles.resume}>
        ...
        <div className={styles.leftColumn}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.skillsLanguagesContainer}>

...
const Resume = forwardRef((props, ref) => {
  ...
  const info = {
    ...
    skills: information[sections.skills], // Ensure skills are included
    languages: information[sections.languages], // Ensure languages are included
  ...
  const sectionDiv = {
    [sections.workExp]: (
      <div
        ...
        className={`${styles.section} page-break`} // Add page-break class
      >

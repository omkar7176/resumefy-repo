...
import styles from "./Template106.css";
    ...
    <div className={styles["resume-container"]}>
      ...
      <div className={styles["left-panel"]}>
        ...
        <section>
          ...
          <div>
            ...
            <ul className={styles["job-list"]}>
              <li>Implemented cost-control measures resulting in a 15% reduction in operational expenses.</li>
              <li>Streamlined financial reporting processes, enhancing overall efficiency by 20%.</li>
              <li>Led a team in successfully navigating a complex audit, ensuring compliance with industry regulations.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className={styles["job-list"]}>
              <li>Managed month-end close processes, reducing closing time by 25%.</li>
              <li>Implemented a new financial forecasting system, improving accuracy by 18%.</li>
              <li>Collaborated with cross-functional teams to develop and implement financial strategies, resulting in a 10% increase in revenue.</li>
              <li>Spearheaded automation, decreasing manual workload by 30%.</li>
            </ul>
          </div>
        </section>
        ...
        <section>
          ...
          <div>
            <h3 className={styles["degree-title"]}>Master of Business Administration (MBA), Financial Management</h3>
            <p className={styles.date}>Sep 2018 - Oct 2019</p>
            <p className={styles.institution}>University of Finance and Management</p>
          </div>
          <div>
            <h3 className={styles["degree-title"]}>Bachelor of Science in Accounting</h3>
      ...
      <div className={styles["right-panel"]}>
        ...
        <section>
          ...
          <ul className={styles["info-list"]}>
            <li>Served as Team Lead in the company-wide initiative for process improvement.</li>
            <li>Volunteer Treasurer, Local Nonprofit Organization.</li>
            <li>Received “Excellence” in Financial Management Award, Borcelle Corporation.</li>
          </ul>
        </section>
      </div>
    </div>

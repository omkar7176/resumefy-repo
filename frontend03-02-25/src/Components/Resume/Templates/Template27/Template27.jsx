...
import styles from "./Template27.module.css"; // Your styles file
import backgroundImage from "./background.png"; // Background image

const Template27 = forwardRef(({ information, sections, activeColor }, ref) => {
  const info = {
    basicInfo: information[sections.basicInfo]?.detail || {},
    workExp: information[sections.workExp]?.details || [],
    education: information[sections.education]?.details || [],
            ...
            <div className={styles.section}>
              ...
              <div className={styles.skillContainer}>
                {info.skills.map((skill, idx) => (
                  <span key={idx} className={styles.skillBubble}>
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.languageContainer}>
                {info.languages.map((language, idx) => (
                  <span key={idx} className={styles.languageBubble}>
                    {language}
                  </span>
                ))}
              </div>

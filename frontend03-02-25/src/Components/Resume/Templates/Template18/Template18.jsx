...
//     return isNaN(d.getTime()) ? "Present" : d.getFullYear();
//   };
...
//                 <div key={index}>
//                   <p>
//                     <strong>{work.title}</strong> | {work.companyName} ({formatDate(work.startDate)} - {formatDate(work.endDate)})
//                   </p>
...
//                 <div key={index}>
//                   <p>
//                     <strong>{edu.title}</strong> | {edu.college} ({formatDate(edu.startDate)} - {formatDate(edu.endDate)})
//                   </p>
//                 </div>
//               ))}
//             </div>
  ...
  const info = {
    ...
    other:
      ...
      (information[sections.other]?.detail
        ? [information[sections.other].detail]
        : []), // handle both points and single detail
  };

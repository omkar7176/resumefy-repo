...
import styles from "./Template49.module.css";

const Template49 = forwardRef(({ information, sections, activeColor }, ref) => {
  const info = {
  ...
  const initials = info.basicInfo.name ? info.basicInfo.name.charAt(0).toUpperCase() : "";
  return (
    <div
